...
from rlbidder.agents.cql import CQLModel  # noqa: E402
...
class ModelConfig:
    ...
    ood_uniform_min: float = 0.0
    ood_uniform_max: float = 100.0
...
class TrainConfig:
    ...
    model_dir: str = str(CURRENT_DIR / "checkpoints" / "cql")
    accelerator: str = "gpu"
...
def main(
    ...
    model = CQLModel(
        ...
        num_models=cfg.model_cfg.num_models,
        ...
        temperature=cfg.model_cfg.temperature,
        cql_alpha=cfg.model_cfg.cql_alpha,
        n_actions=cfg.model_cfg.n_actions,
        cql_target_action_gap=cfg.model_cfg.cql_target_action_gap,
        ...
        ood_uniform_min=cfg.model_cfg.ood_uniform_min,
        ood_uniform_max=cfg.model_cfg.ood_uniform_max,
